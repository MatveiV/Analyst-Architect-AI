...
6. Если данных в документе достаточно — приведи МИНИМУМ 3 риска и МИНИМУМ 5 критериев
   приёмки (требование Option2). Если данных действительно мало — честно верни меньше и
   поставь confidence="low"; не выдумывай риски и критерии ради количества.
